...
class nozzle:
    ...
    def genGmshNozzle(self, outputpath, fname):
        ...
        # add solid wall
        #dyWall = 1
        #l5, l6, l7, l8 = geo.extrudeMesh([0, dyWall, 0], l4, layers=5)

        #geo.addPhysicalLine("INNERWALL",l5)
        #geo.addPhysicalLine("OUTERWALL",l6)
        #geo.addPhysicalLine("INWALL",l7)
        #geo.addPhysicalLine("OUTWALL",l8)
...
%
%
CONFIG_LIST = ({self.su2cfgfile}, {self.su2cfgfile_solid})
%
%
MARKER_ZONE_INTERFACE= (WALL, INNERWALL)
%
%
MARKER_CHT_INTERFACE= (WALL, INNERWALL)
%
%
%MARKER_SYM= ( SYMMETRY )
%
