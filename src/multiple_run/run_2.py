...
if __name__ == "__main__":
    ...
    pass
    doe_file = '/home/ppiper/Dropbox/local/ihtc_repository/data/doe_30/doe_lhs.txt'
    ...
    index_range = [9, 10, 11, 12, 13, 14, 15, 16]
    dataset_root = '/home/ppiper/Dropbox/local/ihtc_repository/data/doe_30'
